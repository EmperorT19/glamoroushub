  ...
  template: `
    <div class="fixed bottom-8 right-8 z-50 flex flex-col items-center space-y-4 animate-fade-in">
      ...
      <a href="https://wa.me/254700000000" target="_blank" 
         class="relative w-14 h-14 bg-[#25D366] flex items-center justify-center text-white hover:bg-white hover:text-[#25D366] hover:-translate-y-1 transition-all duration-300 group shadow-[0_0_20px_rgba(37,211,102,0.4)]"
        ...
        <svg class="w-7 h-7 text-current" fill="currentColor" viewBox="0 0 24 24">
